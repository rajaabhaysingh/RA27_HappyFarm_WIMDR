...
function SearchBarPc(props) {
  ...
  const renderProductSuggestionPC = () => {
    ...
    renderProductSuggestionPC.handleClickOutside = () => setIsOpen(false);
    ...
    return (
      <ul
        className={
          isOpen
            ? "m-menu -active product_suggestion_list"
            : "m-menu product_suggestion_list"
        }
        id="product_suggestion_list"
        onClick={toggle}
      >
...
const clickOutsideConfig = {
  handleClickOutside: () => renderProductSuggestionPC.handleClickOutside,
};

export default onClickOutside(SearchBarPc, clickOutsideConfig);
